    ...
    return (
        <section id="achievements" className="section">
            ...
            <style>{`
                ...
                .exp-card:hover { border-color: var(--primary); transform: translateX(10px); }
                ...
                .exp-card .period { background: rgba(139, 92, 246, 0.1); padding: 4px 12px; border-radius: 100px; font-size: 0.75rem; font-weight: 600; color: var(--primary); }
                .exp-card .desc { color: var(--text-secondary); font-size: 0.9375rem; }
            `}</style>
        </section>
    );
};
